...
this.depend = function() {
  ...
  if (B.size() == 0) {
    console.log('no more buttons.  going bye bye.')
...
let F = new ProblemFunction(function(x) { return 10 * x; }, 'position of car', 3.5, [xlow,xhigh], [0,1,2,3,4]);
