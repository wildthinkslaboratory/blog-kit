...
#### --outlinebox right1
[Drive!](:=play=true)
Remember when we found the velocity of the car at a specific time from the car's position graph?  We used a secant to estimate it.   A very small secant that included the time point gave a good estimate of the speed at that time.  The smaller we made the secant, the better the estimate. 
